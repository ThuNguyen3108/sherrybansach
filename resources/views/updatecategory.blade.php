                ...
                <div class="card">
                    <div class="card-add">
                        ...
                        <div class="table-responsive">
                            <form action="{{URL::to('update/'.$namecategory->id)}}" method="post" id="themsanpham" name="themsanpham">
                            @csrf
                                <table id="addproduct" width="1800">
                                    ...
                                    <tbody>
                                        <td><input class="form-control" required name="tentheloai" id="tensp" type="text" value="{{$namecategory->name}}" placeholder="không rỗng"></td>
                                        <td><button  class="btn btn-outline-warning" id="btnAdd" type="submit" onclick="addItem()">Cập Nhật</button></td>
                                    </tbody>
                                </table>
                                @if (session('status'))
